          ...
          <div className="relative">
            ...
            {dropdownOpen === 2 && (
              <div className="absolute z-50 w-40 py-2 mt-2 bg-white rounded-lg shadow-xl" >
                ...
                <hr />
                <a href="/board/1" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">공지사항</a>
                <a href="/board/2" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">주저리</a>
                <hr />
                <a href="/board/3" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">건의사항</a>
                <a href="/board/4" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">자료실</a>
                <a href="/board/5" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">공모전 및 대회</a>
                <hr />
                <a href="/board/10" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">회의록</a>
                <a href="/board/11" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">장부</a>
                <a href="/board/12" className="block px-4 py-2 text-xs text-gray-800 hover:bg-gray-200">전시회 회의록</a>
